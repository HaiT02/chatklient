...
{
    protected SocketIO? _client;
    protected const string ServerUrl = "wss://api.leetcode.se";
    protected const string Path = "/sys25d";

    public virtual async Task Anslut()
    {
    ...
    public virtual async Task Nedkoppling()
    {
...
public class ChatSocketManager : SocketManager
{
    ...
    public override async Task Anslut()
    {
        Console.WriteLine("förbereder anslutning...");
        await base.Anslut();
    ...
    public async Task Skicka(string text)
    {
    ...
    public override async Task Nedkoppling()
    {
        Console.WriteLine("Kopplar ner...");
        await base.Nedkoppling();
    }
